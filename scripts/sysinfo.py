...
device_white = ['eth0','eth1', 'eth2', 'eth3', 'enp0s3', 'bond1']
...
def get_disk():
    cmd = """/sbin/fdisk -l|grep Disk|egrep -v 'identifier|mapper|Disklabel'|head -1"""
    ...
    return partition_size  # 10.6 + 20.5 + 100
